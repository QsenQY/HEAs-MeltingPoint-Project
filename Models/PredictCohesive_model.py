...
# Model_2
class PredictCohesive(nn.Module):
    def __init__(self, num_elements, embedding_dim, additional_features_dim, padding_value, dropout=0.3422,
                 num_neurons=[299, 235, 62, 59]):
        super(PredictCohesive, self).__init__()
