...
# Model_2
class PredictVEC(nn.Module):
    def __init__(self, num_elements, embedding_dim, additional_features_dim, padding_value, dropout=0.221,
                 num_neurons=[152, 183, 163, 76]):
        super(PredictVEC, self).__init__()
