...
# Model_2
class PredictDensity(nn.Module):
    def __init__(self, num_elements, embedding_dim, additional_features_dim, padding_value, dropout=0.4368,
                 num_neurons=[60, 252, 73, 81]):
        super(PredictDensity, self).__init__()
