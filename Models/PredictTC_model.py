...
# Model_2
class PredictTC(nn.Module):
    def __init__(self, num_elements, embedding_dim, additional_features_dim, padding_value, dropout=0.2465,
                 num_neurons=[250, 299, 127, 99]):
        super(PredictTC, self).__init__()
